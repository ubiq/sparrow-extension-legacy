...
describe('conversion utils', function () {
  ...
  describe('conversionUtil', function () {
    it('Returns expected types', function () {
      ...
      const conv2 = conversionUtil(1, { fromNumericBase: 'dec', fromDenomination: 'UBQ', toDenomination: 'WEI' })
    ...
    it('Converts WEI to ETH', function () {
      assert.equal(conversionUtil('0xde0b6b3a7640000', { fromNumericBase: 'hex', toNumericBase: 'dec', fromDenomination: 'WEI', toDenomination: 'UBQ' }), 1)
      assert.equal(conversionUtil('0x14d1120d7b160000', { fromNumericBase: 'hex', toNumericBase: 'dec', fromDenomination: 'WEI', toDenomination: 'UBQ' }), 1.5)
    })
    it('Converts ETH to WEI', function () {
      assert.equal(conversionUtil('1', { fromNumericBase: 'dec', fromDenomination: 'UBQ', toDenomination: 'WEI' }), 1000000000000000000)
      assert.equal(conversionUtil('1.5', { fromNumericBase: 'dec', fromDenomination: 'UBQ', toDenomination: 'WEI' }), 1500000000000000000)
    })
    it('Converts ETH to GWEI', function () {
      assert.equal(conversionUtil('1', { fromNumericBase: 'dec', fromDenomination: 'UBQ', toDenomination: 'GWEI' }), 1000000000)
      assert.equal(conversionUtil('1.5', { fromNumericBase: 'dec', fromDenomination: 'UBQ', toDenomination: 'GWEI' }), 1500000000)
    })
