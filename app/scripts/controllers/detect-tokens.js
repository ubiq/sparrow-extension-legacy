...
import contracts from 'ubq-contract-metadata'
...
const SINGLE_CALL_BALANCES_ADDRESS = '0x068841237e0efcfbd3201f1f321fc915987d94e3'
...
export default class DetectTokensController {
  ...
  /**
   * For each token in ubq-contract-metadata, find check selectedAddress balance.
   */
